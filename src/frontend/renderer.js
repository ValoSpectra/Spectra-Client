document.querySelector("#ConnectButton").addEventListener("click", () => {
  ...
  const leftTeam = {name: document.getElementById("TeamLeftNameInput").value, tricode: document.getElementById("TeamLeftTricodeInput").value, url: document.getElementById("TeamLeftLogoInput").value, attackStart: teamLeftAttackerStart};
  const rightTeam = {name: document.getElementById("TeamRightNameInput").value, tricode: document.getElementById("TeamRightTricodeInput").value, url: document.getElementById("TeamRightLogoInput").value, attackStart: !teamLeftAttackerStart};
